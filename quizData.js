const quizData = [
    ...
    {
        id: 21,
        question: "21. For a polyester shown below, which R’ group listed would lead to highest fusion, or melting, temperature (remember that Tf= Hf/Sf)?",
        hasImage: true,
        options: ["a.", "b.", "c.", "d."],
        optionImages: [null, null, null, null],
        answer: 2
    ...
    {
        id: 22,
        question: "22. For a polyester shown below, which R” group listed would lead to highest fusion, or melting, temperature (remember that Tf= Hf/Sf)?",
        hasImage: true,
        options: ["a.", "b.", "c.", "d."],
        optionImages: [null, null, null, null],
        answer: 3
